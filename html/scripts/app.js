(function(){
	...
	let menus = {
		...
		vehiclespawner : {
		  ...
		  items: [
		    {label: 'Petite Remorqueuse', value: 'towtruck2'},
		  	{label: 'Remorqueuse', value: 'towtruck'},
		  	{label: 'Camion-Remorqueur', value: 'flatbed'},
		  ]
		},
		actions : {
		  title     : 'Metier',
		  ...
		  items : [
		  	{label: 'Réparer Véhicule',  value: 'reparer'},
		  	{label: 'Crocheter Véhicule', value: 'crocheter'},
		  	{label: 'Charger Véhicule (flatbed only)', value: 'charger'},
